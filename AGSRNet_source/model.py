...
from AGSRNet_source.layers import *
from AGSRNet_source.ops import *
from AGSRNet_source.preprocessing import normalize_adj_torch
...
class moritz_AGSRNet(nn.Module):

    def __init__(self, ks, args):
        super(moritz_AGSRNet, self).__init__()
