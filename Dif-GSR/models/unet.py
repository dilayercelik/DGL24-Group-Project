...
class ContextUnet(nn.Module):
    def __init__(self, in_channels, n_feat=256, n_classes=10):
        ...
        self.to_vec = nn.Sequential(nn.AvgPool2d(67), nn.GELU()) #EDITED Moritz (was 40)
        ...
        self.up0 = nn.Sequential(
            ...
            nn.ConvTranspose2d(2 * n_feat, 2 * n_feat, 67, 67),  # otherwise just have 2*n_feat #EDITED Moritz (was 40)
